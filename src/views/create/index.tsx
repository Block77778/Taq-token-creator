        ...
        <div className="bg-default-950/40 mx-auto max-w-5xl overflow-hidden rounded-2xl backdrop-blur-2xl">
          <div className="grid gap-10 lg:grid-cols-2">
            <Branding
              ...
              message="Create and manage your Solana token in minutes — no code required. Visit creatememecoins.online to get started."
            />
            <div className="lg:ps-0 flex h-full flex-col p-10">
              <div className="pb-10">
                <a href="/" className="flex">
                  <img src={"assets/images/logo-new.png"} alt="Create Meme Coin Online" className="h-10" />
                </a>
              </div>
              <div className="my-auto pb-6 text-center">
                ...
                <div className="flex items-start justify-center">
                  <img src={token.image || "assets/images/logo-new.png"} alt="" className="h-40 rounded-xl" />
                </div>
