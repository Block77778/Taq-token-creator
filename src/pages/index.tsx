...
const Home: NextPage = () => {
  ...
  return (
    <>
      <Head>
        <title>Create Meme Coin Online — Launch Your Solana Token</title>
        <meta name="description" content="Create and deploy Solana tokens without writing a single line of code. The all-in-one memecoin platform at creatememecoins.online." />
      </Head>
